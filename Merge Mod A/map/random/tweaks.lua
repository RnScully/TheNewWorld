...
RandomWorld = {
	...
	moisture = { -- Moisture map
		...
		sea_add 			= 80, 				-- Added to moisture value for each water pixel (x20, base is 4)
		start_moisture 		= 0, 				-- Start moisture value from beginning of map (NOT only continents)(x0, base is 100)
		min_promille 		= 4, 				-- How much rain will fall for every pixel, no matter what  (x0.3, base is 12)
	...
	terrain = { -- Terrain
		...
		desert_moisture				= 0,
		desert_grasslands_moisture	= 0,
		grasslands_moisture			= 1,
		
		grasslands_noise_freq_x		= 4.5,
		grasslands_noise_freq_y		= 4.5,
		...
		tropical_heat				= 255, -- Above this is tropical
		subtropic_heat				= 254, -- Above this is subtropical ( arid but rains more so can easier end up savannah or jungle )(base is 210, changed to make all deserts subtropical)
		temperate_heat				= 253, -- Above this is arid ( deserts ) 
		frigid_heat					= 0, -- Above this is temperate below is frigid
		
		severe_winter_heat			= 80,
		normal_winter_heat			= 120,
		mild_winter_heat			= 160,
	},	
	...
	climate = {
		...
		tropical_start 		= 0.20,
		tropical_end 		= 1.0,
		normal_winter_end 	= 0.12,
		mild_winter_end 	= 0.15,
